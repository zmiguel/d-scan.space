...
vi.mock('../../../src/lib/database/schema.js', () => ({
    characters: { id: 'characters.id', name: 'characters.name', sec_status: 'characters.sec_status', corporation_id: 'characters.corporation_id', alliance_id: 'characters.alliance_id', last_seen: 'characters.last_seen', updated_at: 'characters.updated_at', esi_cache_expires: 'characters.esi_cache_expires', deleted_at: 'characters.deleted_at' },
    ...
    describe('getCharactersByName', () => {
        ...
        describe('updateCharactersLastSeen', () => {
            it('should update last seen timestamp', async () => {
                ...
                await updateCharactersLastSeen(ids);
